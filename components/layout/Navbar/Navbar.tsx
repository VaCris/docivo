                    ...
                    <div className="flex justify-between items-center h-12">
                        ...
                        <div className="hidden md:flex items-center gap-2">
                            <button
                                type="button"
                                onClick={toggleTheme}
                                className="inline-flex justify-center items-center hover:bg-surface-100 rounded-lg w-9 h-9 text-surface-400 hover:text-surface-700 transition-colors focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2 focus:ring-offset-surface-0"
                            ...
                            <button
                                ...
                                className="inline-flex justify-center items-center hover:bg-surface-100 rounded-lg w-9 h-9 font-sans font-bold text-surface-400 hover:text-surface-700 text-xs transition-colors focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2 focus:ring-offset-surface-0"
                        ...
                        <div className="md:hidden flex items-center gap-1">
                            <button
                                type="button"
                                onClick={toggleTheme}
                                className="flex justify-center items-center hover:bg-surface-100 rounded-lg w-9 h-9 text-surface-500 hover:text-surface-900 transition-colors focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2 focus:ring-offset-surface-0"
                                aria-label={isDark ? "Activate light mode" : "Activate dark mode"}
                            >
                                <Icon
                                    icon={
