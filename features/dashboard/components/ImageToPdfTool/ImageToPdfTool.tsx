    ...
    return (
        <div className="tool-accent-image flex flex-col h-[calc(100vh-8rem)]">
            ...
            <div className="flex lg:flex-row flex-col flex-1 gap-6 overflow-hidden">
                <div className="dashboard-panel relative flex flex-col flex-1 shadow-sm p-6 border rounded-2xl overflow-y-auto">
                    <div className="gap-4 grid grid-cols-2 sm:grid-cols-3 xl:grid-cols-4">
                        {images.map((item) => (
                            <div
                                key={item.id}
                                className="dashboard-tool-accent-hover group relative bg-surface-100 border border-surface-200 rounded-xl aspect-square overflow-hidden transition-all"
                            >
                                <img
                                    src={item.previewUrl}
                                    alt={item.file.name}
                ...
                <div className="dashboard-panel flex flex-col shadow-sm p-6 border rounded-2xl w-full lg:w-80 overflow-y-auto shrink-0">
                        ...
                        <div>
                            ...
                            <div className="gap-3 grid grid-cols-2">
                                <button
                                    ...
                                    className={`flex flex-col items-center justify-center gap-2 p-3 rounded-xl border-2 transition-colors ${orientation === "portrait" ? "dashboard-tool-choice-selected" : "border-surface-200 text-surface-500 hover:bg-surface-50"}`}
                                >
                                ...
                                <button
                                    ...
                                    className={`flex flex-col items-center justify-center gap-2 p-3 rounded-xl border-2 transition-colors ${orientation === "landscape" ? "dashboard-tool-choice-selected" : "border-surface-200 text-surface-500 hover:bg-surface-50"}`}
                                >
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                >
                                    ...
                                    <option value="letter">{strings.settings.sizes.letter}</option>
                                </select>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                >
                                    ...
                                    <option value="large">{strings.settings.margins.large}</option>
                                </select>
                                <Icon icon="solar:alt-arrow-down-linear" width="16" className="top-1/2 right-4 absolute text-surface-400 -translate-y-1/2 pointer-events-none" />
                            </div>
                        </div>
